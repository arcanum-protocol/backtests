...
# Case 4: Check volatility with no price difference
if __name__ == "__main__":
    candles = pd.read_csv('candles.csv')

    init_price = 61151.76
    lower_bound = 61151.76
    upper_bound = 63705.68
    interval = (datetime.datetime(2024, 3, 1), datetime.datetime(2024, 10, 1))
